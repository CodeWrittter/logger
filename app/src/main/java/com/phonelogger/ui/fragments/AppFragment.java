...
import com.phonelogger.BuildConfig;
import com.phonelogger.R;
import com.phonelogger.db.LogDao;
import com.phonelogger.receivers.AdminReceiver;
...
public class AppFragment extends Fragment {
    ...
    private ComponentName launcherAlias() {
        return new ComponentName(requireContext(), "com.phonelogger.ui.LauncherAlias");
    }
    ...
    private void runSetupWizard() {
        String[] steps = {
                "1. Notification Access\n→ Enable PhoneLogger in the list",
                "2. Location\n→ Set to "Allow all the time"",
                "3. Usage Stats\n→ Enable for PhoneLogger",
    ...
    private void confirmDisableReset() {
        new AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Reset", (d, w) -> {
                    ...
                    // Wipe prefs
                    requireContext().getSharedPreferences("phonelogger", Context.MODE_PRIVATE)
                            .edit().clear().apply();
                    // Deactivate admin
                    DevicePolicyManager dpm = (DevicePolicyManager)
                            requireContext().getSystemService(Context.DEVICE_POLICY_SERVICE);
